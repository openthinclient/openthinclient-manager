...
/**
 * <p>Die Klasse cPortScanner führt einen Port Scan auf einen Zielrechner durch.
 * Hierfür werden die Übergabeparameter aus dem Konstruktor genutzt</p>
 *
...
public class cPortScanner implements Runnable {
     ...
     * gesetzt, der vom Konstruktor übergeben wird.
     */
    String host;

    /**
     * Der Konstruktor der Klasse cPortScanner hat zwei Übergabeparameter. 
     * Der erste Übergabewert (String host) dient zur Bestimmung des Zielrechners. 
     ...
     * Übergabeparamater (int port) bestimmt den Port, auf dem der Zielrechner 
     ...
     * Sie führt einen Portscan auf den jeweiligen Host und Port durch.
     * 
     ...
     *
     * <tr><td>Sollte die IP-Adresse bzw. der Hostname ungültig sein oder nicht aufgelöst
     * werden können</td> <td>Unkown Host 192.168.1.10</td></tr>
     *
     * <tr><td>Wenn der Host erreichbar ist, jedoch keine Verbindung auf dem jeweiligen Port
     * zulässt</td>     <td>No Connection to 192.168.1.10 on Port 67</td></tr>
     * </table>
     */
    public void run() {
