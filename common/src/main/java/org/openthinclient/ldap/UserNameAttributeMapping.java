 ...
 */
public class UserNameAttributeMapping extends AttributeMapping {

  public UserNameAttributeMapping(String fieldName)
  ...
  protected Method getGetter() throws NoSuchMethodException {
    return type.getMappedType().getMethod("getUserName");
  }

  @Override
  protected Method getSetter() throws NoSuchMethodException {
    return type.getMappedType().getMethod("setUserName", String.class);
  }
}
