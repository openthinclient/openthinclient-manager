...
public interface SchemaProvider {
   ...
   */
  String[] getSchemaNames(Class<? extends DirectoryObject> profileType) throws SchemaLoadingException;
   ...
   */
  Schema getSchema(Class<? extends DirectoryObject> profileType, String schemaName) throws SchemaLoadingException;
