...
# Source jadice server local options if they exist
if [ -f "../server-config/jadice-server-local.sh" ]
then
	. "../server-config/jadice-server-local.sh"
fi
