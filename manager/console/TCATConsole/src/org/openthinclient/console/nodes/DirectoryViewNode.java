...
public class DirectoryViewNode extends PartitionNode {
   ...
   * @param rdn
   */
  public DirectoryViewNode(Node node, LDAPConnectionDescriptor lcd, String dn) {
    super(node, lcd, dn);
  }
   ...
   */
  public DirectoryViewNode(LDAPConnectionDescriptor connectionDescriptor) {
  ...
  public String getName() {
    return Messages.getString("DirectoryViewNode.name"); //$NON-NLS-1$
  }
