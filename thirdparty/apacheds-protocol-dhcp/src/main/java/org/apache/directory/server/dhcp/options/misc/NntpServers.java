 ...
 * Servers SHOULD be listed in order of preference. The code for the NNTP server
 * option is 71. The minimum length for this option is 4 octets, and the length
