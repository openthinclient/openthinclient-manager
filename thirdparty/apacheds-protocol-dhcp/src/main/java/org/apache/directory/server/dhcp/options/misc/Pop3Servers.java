 ...
 * Servers SHOULD be listed in order of preference. The code for the POP3 server
 * option is 70. The minimum length for this option is 4 octets, and the length
