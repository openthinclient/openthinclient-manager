 ...
 * field within the BOOTP response, with the following exceptions: - the length
 * of the file is unconstrained; - all references to Tag 18 (i.e., instances of
 * the BOOTP Extensions Path field) within the file are ignored. The code for
 * this option is 18. Its minimum length is 1.
 */
