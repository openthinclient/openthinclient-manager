 ...
 * subnet of that network to which the client is directly connected. A value of
 * 1 indicates that all subnets share the same MTU. A value of 0 means that the
 * client should assume that some subnets of the directly connected network may
 * have smaller MTUs. The code for this option is 27, and its length is 1.
 */
