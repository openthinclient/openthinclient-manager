		...
		try {
			...
			if (stream != null) {
				...
				PreferenceStoreHolder.addPreferenceStoreByName(tempStoreName,
						tempPrefStore);
				new ProxyProperties( prefStHo.getPreferenceAsString(
						"PackageManager", "proxyHost", null), prefStHo.getPreferenceAsString(
								"PackageManager", "proxyPort", null), prefStHo.getPreferenceAsString(
										"PackageManager", "proxyUser", null), prefStHo.getPreferenceAsString(
												"PackageManager", "proxyPass", null),prefStHo.getPreferenceAsBoolean("proxyInUse", false));
			}
			return true;
