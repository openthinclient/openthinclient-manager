...
import org.openthinclient.web.event.DashboardEvent.UserLoginRequestedEvent;
...
public class LoginViewToDelete extends VerticalLayout {

    public LoginViewToDelete() {
        setSizeFull();
    ...
    private Component buildLabels() {
        ...
        Label title = new Label("openthinclient.org Dashboard");
