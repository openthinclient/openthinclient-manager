...
import org.openthinclient.web.event.DashboardEvent.PostViewChangeEvent;
import org.openthinclient.web.event.DashboardEvent.ProfileUpdatedEvent;
import org.openthinclient.web.event.DashboardEvent.ReportsCountUpdatedEvent;
import org.openthinclient.web.event.DashboardEvent.TransactionReportEvent;
...
public final class DashboardMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("openthinclient.org <strong>Dashboard</strong>",
                ContentMode.HTML);
    ...
    // TODO JN: get UserProfile-data form DataSource (LDAP) to edit a user-profile in vaadin
    ...
    @Subscribe
    // TODO JN: Notification count 
    public void updateNotificationsCount(final NotificationsCountUpdatedEvent event) {
        int unreadNotificationsCount =  1; //  DashboardUI.getDataProvider().getUnreadNotificationsCount();
