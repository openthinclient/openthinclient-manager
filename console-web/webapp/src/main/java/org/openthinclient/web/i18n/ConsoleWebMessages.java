...
public enum ConsoleWebMessages {
  ...
  UI_FILEBROWSER_LOCATION_LABEL_HINT,

  UI_PRINTER_HEADER,
  UI_APPLICATION_HEADER,
  UI_HWTYPE_HEADER,
  UI_HWTYPE,
  UI_FROM_HWTYPE_HEADER,
  UI_DEVICE_HEADER,
  UI_SETTINGS_HEADER,
  ...
  UI_LOCATION_HEADER,
  UI_LOCATION,
  UI_FROM_LOCATION_HEADER,
  UI_USER_HEADER,
  UI_USER,
  UI_ADMIN_USER_HEADER,
  UI_CLIENTGROUP_HEADER,
  UI_CLIENTGROUP,
  UI_FROM_CLIENTGROUP_HEADER,
  UI_APPLICATIONGROUP_HEADER,
  UI_APPLICATIONGROUP,
  UI_USERGROUP_HEADER,
  UI_USERGROUP,
  UI_FROM_USERGROUP_HEADER,
  ...
  UI_DASHBOARDVIEW_PANEL_NEW_BROWSER_FALLBACK,

  UI_DASHBOARDVIEW_PRIVACY_NOTICE_INFO,
  UI_DASHBOARDVIEW_PRIVACY_NOTICE_CAPTION,

  UI_DASHBOARDVIEW_UNREGISTERED_CLIENTS,
  UI_DASHBOARDVIEW_UNREGISTERED_CLIENTS_UPDATE_BUTTON,
  UI_DASHBOARDVIEW_UNREGISTERED_CLIENTS_FORGET_BUTTON,

  UI_DASHBOARDVIEW_LICENSE_INFO_CAPTION,
  UI_DASHBOARDVIEW_LICENSE_INFO_CLIENT_COUNT,
  UI_DASHBOARDVIEW_LICENSE_INFO_COMMUNITY_LICENSE,
  UI_DASHBOARDVIEW_LICENSE_INFO_LICENSE_OK,
  UI_DASHBOARDVIEW_LICENSE_INFO_LICENSE_PROBLEM,
  UI_DASHBOARDVIEW_LICENSE_INFO_LINK,
  ...
  UI_PACKAGEMANAGER_SEARCHFIELD_INPUTPROMPT,
  UI_PACKAGEMANAGER_SHOW_ALL_VERSIONS,
  UI_PACKAGEMANAGER_SHOW_PREVIEW_VERSIONS,
  ...
  UI_PACKAGEMANAGER_PREVIEW_WARNING,
  UI_PACKAGEMANAGER_INSTALLATIONPLAN_LICENSE_CAPTION,
  UI_PACKAGEMANAGER_CONFIRM_LICENSE_INFO,
  ...
  UI_PACKAGESOURCES_DESCRIPTIONTEXT_CAPTION,
  ...
  UI_SUPPORT_APPLICATION_UPDATE_INFO,
  UI_SUPPORT_APPLICATION_UPDATE_DESCRIPTION,
  UI_SUPPORT_APPLICATION_UPDATE_RUNNING,
  UI_SUPPORT_APPLICATION_UPDATE_INSTALLING,
  UI_SUPPORT_APPLICATION_UPDATE_ERROR,
  UI_SUPPORT_APPLICATION_UPDATE_NONE,
  ...
  UI_THINCLIENT_LOG_CAPTION,
  UI_THINCLIENT_LOG_DOWNLOAD_HINT,
  UI_THINCLIENT_LOG_EMPTY,
  UI_THINCLIENT_LOG_ERROR,
  ...
  UI_SUPPORT_LICENSE_NOT_REQUIRED,
  ...
  UI_SUPPORT_LICENSE_STATE_COMMUNITY,
  ...
  UI_SUPPORT_LOGS_HEADER,
  UI_SUPPORT_LOGS_DESCRIPTION,
  UI_SUPPORT_LOGS_SERVER_HEADER,
  UI_SUPPORT_LOGS_SERVER_DESCRIPTION,
  UI_SUPPORT_LOGS_AUDIT_HEADER,
  UI_SUPPORT_LOGS_AUDIT_DESCRIPTION,
  UI_SUPPORT_LOGS_CLIENT_HEADER,
  UI_SUPPORT_LOGS_CLIENT_DESCRIPTION,
  UI_SUPPORT_LOGS_NO_CLIENT_SELECTED,
  UI_SUPPORT_LOGS_CLIENT_SELECT_PLACEHOLDER,
  UI_SUPPORT_LOGS_ACCESS_ERROR,
  UI_SUPPORT_LOGS_NO_FILES_FOUND,
  ...
  UI_COMMON_DELETE_LOGGED_IN_USER_DENIED,
  ...
  UI_PROFILE_PANEL_BUTTON_ALT_TEXT_IP,
  UI_PROFILE_PANEL_BUTTON_ALT_TEXT_DELETE,
  UI_PROFILE_PANEL_BUTTON_ALT_TEXT_COPY,

  UI_PROFILE_WOL_SUCCESS,
  UI_PROFILE_WOL_ERROR,

  UI_PROFILE_WOL_SUCCESS_ALL,
  UI_PROFILE_WOL_ERROR_SOME,
  UI_PROFILE_WOL_ERROR_ALL,
  UI_PROFILE_TIP_LINK,
  ...
  UI_PROFILE_CONFIRM_SHUTDOWN_TITLE,
  UI_PROFILE_CONFIRM_SHUTDOWN_MULTI_MESSAGE,
  UI_PROFILE_CONFIRM_SHUTDOWN_SINGLE_MESSAGE,
  UI_PROFILE_CONFIRM_SHUTDOWN_MULTI_OK,
  UI_PROFILE_CONFIRM_SHUTDOWN_SINGLE_OK,

  UI_PROFILE_CONFIRM_RESTART_TITLE,
  UI_PROFILE_CONFIRM_RESTART_MULTI_MESSAGE,
  UI_PROFILE_CONFIRM_RESTART_SINGLE_MESSAGE,
  UI_PROFILE_CONFIRM_RESTART_MULTI_OK,
  UI_PROFILE_CONFIRM_RESTART_SINGLE_OK,

  UI_PROFILE_CONFIRM_REAPPLY_SETTINGS_TITLE,
  UI_PROFILE_CONFIRM_REAPPLY_SETTINGS_MULTI_MESSAGE,
  UI_PROFILE_CONFIRM_REAPPLY_SETTINGS_SINGLE_MESSAGE,
  UI_PROFILE_CONFIRM_REAPPLY_SETTINGS_MULTI_OK,
  UI_PROFILE_CONFIRM_REAPPLY_SETTINGS_SINGLE_OK,
  ...
  UI_SUPPORT_LDIF_IMPORT_EXPORT_HEADER,
  UI_SUPPORT_LDIF_IMPORT_DESCRIPTION,
  UI_SUPPORT_LDIF_IMPORT_SUCCESS,
  UI_SUPPORT_LDIF_IMPORT_FAILED,
  UI_SUPPORT_LDIF_EXPORT_DESCRIPTION,
  UI_SUPPORT_LDIF_EXPORT_SUCCESS,
  UI_SUPPORT_LDIF_EXPORT_FAILED
